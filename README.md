...
**DiGi.AssemblyResolver** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.AssemblyResolver](DiGi.AssemblyResolver)** (Path: `DiGi.AssemblyResolver\DiGi.AssemblyResolver`)
